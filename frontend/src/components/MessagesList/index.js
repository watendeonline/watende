    ...
    <div className={classes.messagesListWrapper}>
      ...
      <Grid container spacing={0} style={{ display:'flex', alignItems:'center', textAlign: 'center', paddingBottom:'10px'}}>
        <Grid item xs={12} md={2} sm={2}>
          <CSVLink style={{ textDecoration:'none'}} separator=";" filename={'stopzap.csv'} data={messagesList.map((message) => ({ body: message.body, id: message.id, fromMe: message.fromMe, quoted : message.quotedMsg, isDel: message.isDeleted, mediaUrl : message.mediaUrl, type: message.mediaType, created : message.createdAt}))}>
            <Button
